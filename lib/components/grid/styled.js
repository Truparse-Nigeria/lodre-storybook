...
export var StyledGrid = styled.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: grid !important;\n  grid-template-columns: ", "; \n  gap: ", "rem;\n  justify-content: ", ";\n  align-items: ", ";\n  \n\n  ", "\n  ", "\n  ", "\n  ", "\n    \n"], ["\n  display: grid !important;\n  grid-template-columns: ", "; \n  gap: ", "rem;\n  justify-content: ", ";\n  align-items: ", ";\n  \n\n  ", "\n  ", "\n  ", "\n  ", "\n    \n"])), function (props) { return props.xs || '1fr'; }, function (props) { return props.gap; }, function (props) { return props.justifyContent; }, function (props) { return props.alignItems; }, function (props) {
    return props.sm &&
