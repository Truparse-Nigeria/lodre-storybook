...
export var RoundedImg = function (_a) {
    var height = _a.height, src = _a.src;
    return (React.createElement(StyledImageRounded, { height: height, src: src }));
};
export var Img = function (_a) {
    var height = _a.height, src = _a.src;
    return (React.createElement(StyledImage, { height: height, src: src }));
};
export default Card;
